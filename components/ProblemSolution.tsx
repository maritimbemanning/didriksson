  ...
  return (
    <section className="py-12">
      <div className="grid md:grid-cols-2 gap-8">
        {/* Problem */}
        <div className="bg-red-500/10 dark:bg-red-500/20 border border-red-500/30 rounded-2xl p-8 space-y-6">
        ...
        {/* Solution */}
        <div className="bg-green-500/10 dark:bg-green-500/20 border border-green-500/30 rounded-2xl p-8 space-y-6">
          <div className="flex items-center gap-3">
