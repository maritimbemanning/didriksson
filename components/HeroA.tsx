      ...
      <div className='text-center space-y-8 max-w-3xl mx-auto'>
        ...
        <div className='flex flex-col sm:flex-row items-center justify-center gap-4 pt-4'>
          ...
          <a
            ...
            className='group inline-flex items-center gap-2 border-2 border-border text-muted hover:border-ocean hover:text-ocean transition-all rounded-xl px-6 py-4 font-semibold text-base w-full sm:w-auto justify-center hover-scale'
          >
