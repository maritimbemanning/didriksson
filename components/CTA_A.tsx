      ...
      <div className='relative text-center p-8 md:p-12 space-y-6'>
        ...
        <div className='flex flex-col sm:flex-row items-center justify-center gap-4 pt-2'>
          ...
          <a
            ...
            className='inline-flex items-center gap-2 border-2 border-white/50 text-white hover:bg-white/10 transition-all rounded-xl px-6 py-4 font-semibold hover-scale'
          >
